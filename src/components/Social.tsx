...
import { Youtube, Twitch, MessageSquare, Send, Phone, Link, Users, Award, Download } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="flex justify-center">
            <div className="text-center relative">
              ...
              <div className="inline-block px-6 py-2 border border-gaming-purple/30 rounded-full bg-black/50 backdrop-blur-sm mb-4">
                <span className="text-gaming-purple font-futuristic tracking-widest text-sm">SQUAD UP</span>
              </div>
          ...
          {socialLinks.map((social, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 text-center mb-3">{social.description}</p>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-2 px-5 py-2 bg-black/50 border border-gaming-purple/30 rounded-full mb-4">
            ...
            <span className="text-sm text-gray-300">Join a community of over 50,000 gamers</span>
          </div>
