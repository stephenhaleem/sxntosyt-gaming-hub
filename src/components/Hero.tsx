        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div ref={subtitleRef} className="mb-10">
            ...
            <div className="flex justify-center gap-2 mb-4">
              ...
              <p className="text-sm text-gray-400">Ranked in Top 1% Globally</p>
            </div>
          </div>
          
          <div ref={ctaRef} className="max-w-2xl mx-auto mb-10 backdrop-blur-sm bg-black/40 p-6 rounded-lg border border-gaming-purple/20 electric-border">
            <p className="text-gray-200 mb-4">
              Welcome to my official gaming headquarters! Check out my gameplay highlights, join my community, and level up with me on this gaming journey.
            </p>
